...
const NavigationDetailsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-8 font-sans bg-gradient-to-r from-[#ffc6c6] via-[#ffc6e5] to-[#e7c6ff] relative">
      ...
      <h1 className="text-4xl font-bold mb-8 text-gray-900">Navigation Component</h1>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white bg-opacity-30 backdrop-filter backdrop-blur-md border border-white border-opacity-20 rounded-lg p-6">
          ...
          <table className="w-full">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="p-2">-</td>
                <td className="p-2">Function to handle click events on navigation items</td>
              </tr>
              <tr>
            <td className="p-2">menuOpen</td>
            <td className="p-2">boolean</td>
            <td className="p-2">false</td>
            <td className="p-2">Whether the navigation menu is open or not shown when open in small screen devices</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="p-2">function</td>
            <td className="p-2">-</td>
            <td className="p-2">Function to handle selection of navigation items</td>
          </tr>
            </tbody>
          </table>
          </div>
      ...
      {/* Navigation Example */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Navigation Example</h2>
        <div className="bg-white bg-opacity-30 backdrop-filter backdrop-blur-md border border-white border-opacity-20 rounded-lg p-6">
          <nav className={`${getGlassyClasses()} flex justify-around flex-col md:flex-row mt-4 py-2`}>
        ...
        <div className={`w-full md:w-auto ${menuOpen ? "block" : "hidden"} md:block`}>
            ...
            <a href="#home" className="hover:bg-white/20 hover:text-pink-600 rounded flex justify-center ">
            <button onClick={() => setSelected('Home')} className={` hover:text-pink-600 px-2 py-1 rounded ${selected === 'Home' ? 'bg-pink-300 text-pink-600' : ''}`}>
              Home
            </button>
            </a>
            <a href="#about" className="hover:bg-white/20 hover:text-pink-600 rounded flex justify-center">
            <button onClick={() => setSelected('About')} className={` hover:text-pink-600 px-2 py-1 rounded ${selected === 'About' ? 'bg-pink-300 text-pink-600' : ''}`}>
              About
            </button>
            </a>
            <a href="#contact" className="hover:bg-white/20 hover:text-pink-600 rounded flex justify-center">
            <button onClick={() => setSelected('Contact')} className={` hover:text-pink-600 px-2 py-1 rounded ${selected === 'Contact' ? 'bg-pink-300 text-pink-600' : ''}`}>
              Contact
            </button>
            </a>
            </ul>
