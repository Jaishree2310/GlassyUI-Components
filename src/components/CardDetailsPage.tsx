...
const CardDetailsPage: React.FC = () => {
  ...
  const CustomCardPreview: React.FC = () => {
    const colors = currentTheme === 'custom' ? customColors : themes[currentTheme];
    return (
      <div className="relative p-8 rounded-xl overflow-hidden" style={{ background: `linear-gradient(to right bottom, ${colors.bg}, ${colors.shadowColor})` }}>
        <div style={getGlassmorphismStyle(colors)} className="p-6 rounded-lg relative z-10">
  ...
  return (
    <Card className="p-4 bg-white bg-opacity-30 backdrop-filter backdrop-blur-md">
      ...
      <p>This is the basic card content.</p>
          ...
          <CopyButton text={`import { Card } from './components/Card';
          ...
          <div className="mb-4">
            ...
            {Object.keys(themes).map((theme) => (
              <button
                ...
                className={`w-6 h-6 rounded-full border-2 mr-2 ${currentTheme === theme ? 'border-blue-500' : 'border-gray-300'
                  }`}
    ...
    <div className="relative z-10 flex flex-col h-full">
      ...
      <div className="mt-auto flex justify-between items-end">
        ...
        <CreditCard className="w-12 h-12" />
                ...
                <CopyButton text={`const GlassmorphicCreditCard: React.FC = () => (
  <div className="w-96 h-56 bg-gradient-to-br from-purple-400 to-blue-500 rounded-xl overflow-hidden relative p-8 text-white shadow-xl">
    <div className="absolute inset-0 bg-black bg-opacity-30 backdrop-filter backdrop-blur-sm"></div>
    <div className="relative z-10 flex flex-col h-full">
      <div className="flex justify-between items-center mb-8">
