...
// type CustomTheme = 'blue' | 'brown' | 'white' | 'black' | 'custom';
...
//           {(['blue', 'brown', 'white', 'black', 'custom'] as CustomTheme[]).map((t) => (
//             <button
//               key={t}
...
//         <input type="range" min="0" max="1" step="0.01" value={opacity} onChange={handleOpacityChange} className="w-full" />
//       </div>

//       <div className="mb-4">
//         <label className="block mb-1">Blur: {blur}px</label>
//         <input type="range" min="0" max="20" step="1" value={blur} onChange={handleBlurChange} className="w-full" />
//       </div>
...
//       <div className="mt-4 bg-gray-200 p-2 rounded relative">
//         <pre className="text-sm overflow-x-auto">
//           {`// Glassmorphism Popup Component
...
//     </pre>
//     <CopyButton 
//     text={`// Glassmorphism Popup Component
//         const Popup = ({ isOpen, onClose, children, bg, textColor, borderColor, opacity, blur }) => {
//           if (!isOpen) return null;
...
//     <p>This is a glassmorphism popup.</p>
//   </div>
// </Popup>`} codeKey="glassmorphismPopup" />
//       </div>
//     </div>
//   );
// };
...
//         <h1 className="text-4xl font-bold mb-8">Glassmorphism Popup</h1>
        
//         <p className="mb-8">A customizable, glassmorphism-styled popup component for displaying modal content with adjustable blur and opacity effects.</p>
...
const CustomPopup: React.FC<{ 
  ...
  // CustomPopup JSX will be in Part 2
  return (
