...
function GroupExample() {
  ...
  return (
    <PageShell>
      ...
      {/* Grouped Checkboxes */}
      <div className={`${getGlassyClasses()} p-6 mb-14 relative`}>
        <h2 className='text-3xl font-bold mb-6 text-white'>Checkbox Groups</h2>
        <p className='mb-6 text-lg text-white opacity-80'>
          Use{' '}
          <code className='bg-black/30 px-2 py-1 rounded'>CheckboxGroup</code>{' '}
          and{' '}
          <code className='bg-black/30 px-2 py-1 rounded'>GroupedCheckbox</code>{' '}
          ...
          <table className='w-full border-collapse min-w-[600px]'>
            <thead>
              <tr className='bg-white bg-opacity-10 border-b border-white/20'>
                <th className='text-left p-4 text-white font-semibold'>Prop</th>
            ...
            <tbody className='divide-y divide-white/10'>
              <tr>
                ...
                <td className='p-4 text-white/80 font-mono text-sm'>boolean</td>
