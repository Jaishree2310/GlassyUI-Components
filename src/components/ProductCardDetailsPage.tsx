...
const ProductCardDetailsPage: React.FC = () => {
    ...
    return (
        <div className='min-h-screen p-8 font-sans bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white relative'>
            <div className='relative z-10'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className='p-2 text-gray-200'>
                                        An object containing product details such as name, original price, discounted price, and discount percentage.
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td className='p-2 text-gray-200'>product.discountPercentage</td>
                                    <td className='p-2 text-gray-200'>number</td>
                                    <td className='p-2 text-gray-200'>-</td>
                                    <td className='p-2 text-gray-200'>
                ...
                <div className={`${getGlassyClasses()} p-8 mb-8`}>
                    <h2 className='text-3xl font-bold mb-6 text-white'>Product Card Example</h2>
