    ...
    return (
        <div className="min-h-screen p-8 font-sans bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white relative">
            <div className="relative z-10">
                ...
                <p className="text-xl mb-8 text-white">A simple button to scroll back to the top of the page.</p>
                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                <tr className="border-b border-gray-300">
                                    ...
                                    <td className="p-2 text-gray-200">Function to execute when the button is clicked</td>
                                </tr>
                                <tr className="border-b border-gray-300">
                                    ...
                                    <td className="p-2 text-gray-200">Tooltip text when hovering over the button</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div className={`${getGlassyClasses()} p-8 mb-8`}>
                    ...
                    <p className="mb-6 text-lg text-white">
                        Customize the button's style through the className prop or inline styles.
                    </p>
                    <button
                        className={`fixed bottom-5 right-5 py-3 px-5 bg-blue-500 rounded-full text-white shadow-lg transition-transform hover:scale-105`}
                        title="Back to Top"
