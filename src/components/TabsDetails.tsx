    ...
    <div className='min-h-screen p-8 font-sans bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white relative'>
      ...
      <div className='relative z-10'>
        ...
        <p className='text-lg text-white mb-8'>
          Tabs provide a seamless navigation experience, featuring filled styles
          for strong emphasis on active selections, outlined designs for a
          minimalist approach, and ghost tabs for a sleek, transparent look.
          Disabled tabs clearly indicate non-interactive options, enhancing
        ...
        <div className={`${getGlassyClasses()} p-8 mb-8 relative`}>
          ...
          <p className='mb-6 text-lg text-white'>
            This is an example of how to use the Tabs component.
          </p>

          {/* Example Code and Copy Button */}
          <div className='relative'>
            <pre className='bg-gray-800 text-white pt-2 p-4 rounded-lg overflow-x-auto whitespace-pre-wrap max-sm:text-[0.55rem]'>
              {`\n<Tabs> \n  <Tab label="Tab 1"> \n    <div>Content for Tab 1</div> \n  </Tab> \n  <Tab label="Tab 2"> \n    <div>Content for Tab 2</div> \n  </Tab> \n</Tabs>`}
            </pre>
            ...
            <button
              onClick={() =>
                copyToClipboard(exampleCodeBasicUsage, 'exampleCode-BasicUsage')
              }
              className={`absolute top-2 right-2 ${getGlassyClasses()} p-2 hover:bg-white/40 transition-all duration-300 z-10`}
              title='Copy to clipboard'
            >
              {copiedStates[`exampleCode-BasicUsage`] ? (
                <Check size={16} className='text-green-600' />
              ) : (
                <Copy size={16} className='text-white' />
              )}
        ...
        <div className={`${getGlassyClasses()} p-8 mb-8`}>
          ...
          <table className='w-full text-left text-white'>
            <thead>
              <tr>
                <th className='bg-gray-400 px-2 px-2 py-2'>Prop</th>
                <th className='bg-gray-400 px-2 py-2'>Type</th>
                <th className='bg-gray-400 px-2 py-2'>Default</th>
                <th className='bg-gray-400 px-2 py-2'>Description</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className='px-2py-2'>The label of the tab</td>
              </tr>
              <tr>
                <td className='bg-gray-400 px-2 py-2'>variant</td>
                <td className='bg-gray-400 px-2 py-2'>string</td>
                <td className='bg-gray-400 px-2 py-2'>&apos;filled&apos;</td>
                <td className='bg-gray-400 px-2 py-2'>
                  The visual variant of the tab. Options: &apos;filled&apos;,
                  &apos;outlined&apos;, &apos;ghost&apos;, &apos;disabled&apos;
                </td>
              </tr>
              <tr>
                <td className='px-2 py-2'>disabled</td>
                <td className='px-2 py-2'>boolean</td>
                <td className='px-2 py-2'>false</td>
                <td className='px-2 py-2'>if true. the tab is disabled</td>
              </tr>
        ...
        <TabsSection
          ...
          onCopy={() =>
            copyToClipboard(
              `Example Code for Filled Tabs`,
              `exampleCode-Filled Tabs`,
            )
          }
        >
          <Tabs>
        ...
        <TabsSection
          ...
          onCopy={() =>
            copyToClipboard(
              `Example Code for Outlined Tabs`,
              `exampleCode-Outlined Tabs`,
            )
          }
        >
          <Tabs>
        ...
        <TabsSection
          ...
          onCopy={() =>
            copyToClipboard(
              `Example Code for Ghost Tabs`,
              `exampleCode-Ghost Tabs`,
            )
          }
        >
          <Tabs>
        ...
        <TabsSection
          ...
          onCopy={() =>
            copyToClipboard(
              `Example Code for Disabled Tabs`,
              `exampleCode-Disabled Tabs`,
            )
          }
        >
          <Tabs>
...
const TabsSection: React.FC<{
  ...
  onCopy: () => void;
  children: ReactNode;
}> = ({ title, description, exampleCode, copied, onCopy, children }) => {
  return (
    <div className={`${getGlassyClasses()} p-8 mb-8 relative`}>
