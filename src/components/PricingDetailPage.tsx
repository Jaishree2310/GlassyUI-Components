...
const PricingDetailPage: React.FC = () => {
  ...
  const ExampleStandardPlan = () => (
    <div className='bg-white bg-opacity-10 rounded-lg shadow-lg p-6 relative overflow-hidden max-w-[500px]'>
      ...
      <a
        href='#'
        className='block w-full py-3 px-6 text-center rounded-md text-white font-medium bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700'
      >
        Choose Standard
      </a>
    </div>
    ...
    <div className='bg-white bg-opacity-10 rounded-lg shadow-lg p-6 relative overflow-hidden max-w-[500px]'>
      ...
      <div className='mb-8'>
        ...
        <p className='mt-4 text-yellow-200'>
          Best for large teams and businesses with advanced needs.
        </p>
      </div>
      <div className='mb-8'>
    ...
    <div className='min-h-screen p-8 font-sans bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white relative'>
      ...
      <div className='relative z-10'>
        ...
        <p className='text-xl mb-8 text-white'>
          A customizable section for displaying content.
        </p>
            ...
            <table className='w-full'>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className='p-2 text-gray-300'>
                    The background color of the pricing card
                  </td>
                </tr>
                <tr className='bg-white bg-opacity-10'>
