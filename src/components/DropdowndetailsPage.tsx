    ...
    return (
        <div className="min-h-screen p-8 font-sans bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white relative">
            ...
            <div className="relative z-10">
                ...
                <p className="text-xl mb-8 text-white">A customizable dropdown menu component.</p>
                ...
                <div className={`${getGlassyClasses()} p-8 mb-8`}>
                    <h2 className="text-3xl font-bold mb-6 text-white">Example Dropdown Menu</h2>
                    <p className="mb-6 text-lg text-white">An example implementation of a dropdown menu.</p>
                    <DropdownMenu
                        options={['Option 1', 'Option 2', 'Option 3']}
