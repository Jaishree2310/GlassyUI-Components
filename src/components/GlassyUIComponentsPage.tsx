      ...
      <div className='container mx-auto px-4 py-8 lg:py-12'>
        ...
        <main>
                ...
                <div className='py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6'>
                  <div className='mx-auto max-w-screen-sm text-center'>
                    ...
                    <p className='mb-4 text-lg font-light text-gray-500 dark:text-gray-400'>
                      Sorry, we can't find that component. You'll find lots to
          ...
          <div className='flex justify-between items-center mt-8'>
            <button
              onClick={prevPage}
              className={`bg-pink-500 text-white px-4 py-2 mx-2 rounded-md rounded-lg ${currentPage === 1
            ...
            <button
              onClick={nextPage}
              className={`bg-pink-500 text-white px-4 py-2 mx-2 rounded-md rounded-lg ${currentPage === totalPages
                ? 'opacity-50 cursor-not-allowed'
                : 'hover:bg-white/20'
                }`}
