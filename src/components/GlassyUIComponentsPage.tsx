...
//   const getGlassyClasses = () => {
//     return 'backdrop-filter backdrop-blur-lg bg-opacity-10 border border-opacity-20 rounded-xl shadow-lg transition-all duration-300 bg-gradient-to-br from-purple-500/30 via-pink-500/30 to-orange-500/30 border-white/20 text-white';
//   };

//   return (
//     <div className="min-h-screen p-8 font-sans bg-black relative overflow-hidden">
//       <div className="absolute inset-0 z-0">
//         <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 filter blur-3xl opacity-30 animate-blob"></div>
//         <div className="absolute top-[60%] right-[-5%] w-[30%] h-[30%] rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
//         <div className="absolute bottom-[-10%] left-[20%] w-[40%] h-[40%] rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
//       </div>
...
//         <main className="space-y-12">
//           <div>
//             <h1 className="text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500">Components</h1>
//             <p className="text-xl mb-8 opacity-80">Elevate your UI with our collection of glassmorphic components.</p>
//           </div>
...
//             >
//               <div className={`w-full h-4 ${getGlassyClasses()} overflow-hidden`}>
//                 <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 h-full" style={{ width: '60%' }}></div>
//               </div>
//             </ComponentCard>
...
//       <div className="absolute inset-[-100%] bg-gradient-to-r from-transparent via-white to-transparent opacity-20 animate-glassy-shine" />
//     </div>
//     <h3 className="text-2xl font-bold mb-2 relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500">{title}</h3>
//     <p className="mb-4 opacity-80 relative z-10">{description}</p>
//     <div className="mt-auto relative z-10">
//       {children}
//     </div>
